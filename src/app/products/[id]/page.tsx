      ...
      <Card className="mb-8">
        ...
        <CardContent className="grid md:grid-cols-2 gap-4">
          ...
          <div className="space-y-4">
            ...
            <p><span className="font-semibold">Buying Price:</span> ${product?.buyingPrice.toFixed(2)}</p>
            <p><span className="font-semibold">Selling Price:</span> ${product?.sellingPrice.toFixed(2)}</p>
            ...
            <TableBody>
              {product.sales.map((saleItem) => (
                <TableRow key={saleItem.id}>
                  ...
                  <TableCell>${saleItem.price.toFixed(2)}</TableCell>
                  <TableCell>${saleItem.total.toFixed(2)}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
